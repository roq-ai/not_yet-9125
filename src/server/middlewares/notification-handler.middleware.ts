...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'invoice.create': { roles: ['owner', 'finance-manager'], key: 'invoice-uploaded', tenantPath: [], userPath: [] },
  'invoice.update': { roles: ['owner', 'finance-manager'], key: 'invoice-updated', tenantPath: [], userPath: [] },
  'invoice.delete': { roles: ['owner', 'finance-manager'], key: 'invoice-deleted', tenantPath: [], userPath: [] },
  'access.delete': { roles: ['owner'], key: 'user-access-removed', tenantPath: [], userPath: [] },
  'settings.update': { roles: ['owner'], key: 'company-settings-updated', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'accountant', 'finance-manager', 'administrator'];
