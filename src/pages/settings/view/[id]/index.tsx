...
import { getSettingsById } from 'apiSdk/settings';
import { SettingsInterface } from 'interfaces/settings';

function SettingsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('settings', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/settings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Invoice Due Days" text={data?.invoice_due_days} />

                <FormListItem label="Currency" text={data?.currency} />

                <FormListItem label="Timezone" text={data?.timezone} />
