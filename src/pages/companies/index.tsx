...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'access.count', 'invoice.count', 'settings.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('invoice', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('settings', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'settings',
          header: 'Settings',
          accessorKey: 'settings',
          cell: ({ row: { original: record } }: any) => record?._count?.settings,
        }
      : null,
