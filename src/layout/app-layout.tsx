...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'accountant', 'finance-manager', 'administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Settings', path: '/settings', entity: 'settings', service: AccessServiceEnum.PROJECT, icon: FiSettings },
